...
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var _app_domain_assigned_jobs__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../app/domain/assigned-jobs */ "./src/app/domain/assigned-jobs.ts");
...
var AppServiceService = /** @class */ (function () {
    ...
    AppServiceService.prototype.getAssignedJobs = function () {
        var response = [];
        response.push(new _app_domain_assigned_jobs__WEBPACK_IMPORTED_MODULE_2__["AssignedJobs"]('JobId1', "Chennai", "04-MAY-2019"));
        response.push(new _app_domain_assigned_jobs__WEBPACK_IMPORTED_MODULE_2__["AssignedJobs"]('JobId2', "Chennai", "05-MAY-2019"));
        response.push(new _app_domain_assigned_jobs__WEBPACK_IMPORTED_MODULE_2__["AssignedJobs"]('JobId3', "Chennai", "06-MAY-2019"));
        return response;
    };
...
/***/ "./src/app/domain/assigned-jobs.ts":
/*!*****************************************!*\
  !*** ./src/app/domain/assigned-jobs.ts ***!
  \*****************************************/
/*! exports provided: AssignedJobs */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "AssignedJobs", function() { return AssignedJobs; });
var AssignedJobs = /** @class */ (function () {
    function AssignedJobs(job, jobloc, jobDate) {
        this.job = job;
        this.jobLocation = jobloc;
        this.jobDate = jobDate;
    }
    AssignedJobs.prototype.getJob = function () {
        return this.job;
    };
    AssignedJobs.prototype.setJob = function (val) {
        this.job = val;
    };
    AssignedJobs.prototype.getJobLocation = function () {
        return this.jobLocation;
    };
    AssignedJobs.prototype.setJobLocation = function (val) {
        this.jobLocation = val;
    };
    AssignedJobs.prototype.getJobDate = function () {
        return this.jobDate;
    };
    AssignedJobs.prototype.setJobDate = function (val) {
        this.jobDate = val;
    };
    return AssignedJobs;
}());
...
var MapViewComponent = /** @class */ (function () {
    function MapViewComponent(modalService) {
    ...
    MapViewComponent.prototype.addMarker = function (lat, lng) {
        this.markers.push({ lat: lat, lng: lng, alpha: 0.4, icon: this.iconBase + 'https://img.icons8.com/color/32/000000/today.png' });
    };
